import CadastroComponent from '../src/app/cadastrar'
import { render, screen, userEvent, fireEvent, act, renderHook } from '../src/utils/tests'
import useCadastro from '../src/data/signup';
import { addCleanup, cleanup } from '@testing-library/react-hooks';
import useLogin from '../src/data/signin';
